...
not have to wade through the [Full VCF upgrade sequence](13-vcf-upgrade-sequence.md)'s
9-phase list to find the two or three steps that actually apply to them.
...
picture, and it is the same 6-step sequence already written up in
...
steps](14-standalone-vvf-upgrade.md#standalone-vvf-manual-upgrade--exact-steps)**
...
- **Post-upgrade validation** – the standalone-VVF track's
  [Post-upgrade validation](14-standalone-vvf-upgrade.md#post-upgrade-validation)
  checklist applies here too.
