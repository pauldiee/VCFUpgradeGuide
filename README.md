...
| `docs/20-patching-an-existing-vcf9-fleet.md` | Patching a fleet already on VCF 9.x to a later maintenance release – depot prep, mandatory component order, UI walkthrough, gotchas |
